...
public class Repo {
    ...
    final public static Repo GOOGLE_MAVEN_CENTRAL_AMERICAS = new Repo("google-maven-central-americas", "https://maven-central.storage-download.googleapis.com/repos/central/data/");
    final public static Repo GOOGLE_MAVEN_CENTRAL_EUROPE = new Repo("google-maven-central-europe", "https://maven-central-eu.storage-download.googleapis.com/repos/central/data/");
    final public static Repo GOOGLE_MAVEN_CENTRAL_ASIA = new Repo("google-maven-central-asia", "https://maven-central-asia.storage-download.googleapis.com/repos/central/data/");
    // end snippet
